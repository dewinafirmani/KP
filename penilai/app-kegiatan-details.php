                        ...
                        <table class="table data-list-view">
                            ...
                            <tbody>
                                <tr>
                                    <td></td>
                                    <td class="item">a1</td>
                                    <td class="uraian_kegiatan">Tabulasi pengumpulan data Pendis2017  
                                    Tabulasi pengumpulan data keagamaan Katolik Tahun 2017
                                    </td>
                                    <td class="tanggal">20 Januari 2020</td>
                                    <td class="satuan_hasil">Pertemuan</td>
                                    <td class="jumlah_volume">140</td>
                                    <td class="angka_kredit">0,016</td>
                                    <td class="jumlah_kredit">2,240</td>
                                    <td class="bukti_fisik">Terlampir</td>
                                    <td class="product-action">
                                        <a  class="feather icon-edit" href='edit_detail.php'></a>
                                        <a  class="feather icon-trash" href='edittransaksi.php?no_transaksi=$user_data[no_transaksi]'></a>
                                    </td>
                                </tr>
                                <tr>
                                    <td></td>
