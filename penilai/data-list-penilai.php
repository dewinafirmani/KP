    ...
    <div class="main-menu menu-fixed menu-dark menu-accordion menu-shadow" data-scroll-to-active="true">
        ...
        <div class="main-menu-content">
            <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
                ...
                <li class=" nav-item"><a href="data-list-penilai.php"><i class="feather icon-circle"></i><span class="menu-title" data-i18n="Colors">Rekap Kegitan</span></a>
                </li>
            </ul>
        </div>
    </div>
                        ...
                        <table class="table data-list-view">
                            ...
                            <tbody>
                                <tr>
                                    <td></td>
                                    <td class="no">1</td>
                                    <td class="unsur">Pendidikan</td>
                                    <td class="sub_unsur">Pendidikan sekolah dan memperoleh gelar/ijasah.</td>
                                    <td class="butir_kegiatan">Membuat rencana tabulasi kegiatan statistik</td>
