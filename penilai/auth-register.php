                        ...
                        <div class="card bg-authentication rounded-0 mb-0">
                            <div class="row m-0">
                                <div class="col-lg-90 col-100 p-0">
                                    ...
                                    <div class="col-lg-6 d-lg-block d-none text-center pl-0 pr-3 py-0">
                                        ...
                                        <div class="card-content">
                                            <div class="card-body pt-0">
                                                <form action="index.php">
                                                    ...
                                                    <div class="form-label-group">
                                                        <input type="email" id="inputEmail" class="form-control" placeholder="NIP" required>
                                                        <label for="inputEmail">NIP</label>
                                                    </div>
                                                    <div class="card-title">
                                                        <h5 class="mb-0">Nomor Seri Kapreg</h5>
                                                    </div>
                                                    <div class="form-label-group">
                                                        <input type="text" id="inputName" class="form-control" placeholder="No. Seri Kapreg" required>
                                                    ...
                                                    <div class="form-label-group">
                                                        <input type="text" id="inputName" class="form-control" placeholder="Tempat Tanggal Lahir" required>
                                                    ...
                                                    <div class="form-label-group">
                                                        <input type="text" id="inputName" class="form-control" placeholder="Jenis Kelamin" required>
                                                    ...
                                                    <div class="form-label-group">
                                                        <input type="text" id="inputName" class="form-control" placeholder="Pendidikan" required>
                                                    ...
                                                    <div class="form-label-group">
                                                            ...
                                                            <ul class="dropdown-menu dropdown-menu-dark" aria-labelledby="dropdownMenuButton2">
                                                                <li><a class="dropdown-item active" href="#">Muda</a></li>
                                                                <li><a class="dropdown-item" href="#">Madya</a></li>
                                                            </ul>
                                                    </div>
                                                    <div class="card-title">
                                                    ...
                                                    <div class="form-label-group">
                                                        <input type="text" id="inputName" class="form-control" placeholder="Unit Kerja" required>
