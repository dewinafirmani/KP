...
<head>
    ...
    <link rel="shortcut icon" type="image/x-icon" href="app-assets/images/ico/kementerian_logo.png">
                        ...
                        <div class="card bg-authentication rounded-0 mb-0">
                            <div class="row m-0">
                                <div class="col-lg-6 d-lg-block d-none text-center align-self-center px-1 py-0">
                                    <img src="app-assets/images/pages/kementerian_logo.png" alt="branding logo">
                                </div>
